...
namespace Kinex\CustomContact\Controller\Index;
...
{  
     ...
     * @param Contactus $contactusFactory
     */
    public function __construct(
        ...
        Contactus $contactusFactory = null,
    ) {
        ...
        $this->contactusFactory = $contactusFactory ?: ObjectManager::getInstance();
    ...
    {   
        ...
        try {
            ...
            if ($data) {
                 /** @var \Kinex\CustomContact\Model\Contactus $model */
                 $model = $this->contactusFactory->create('Kinex\CustomContact\Model\Contactus');
